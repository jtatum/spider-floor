...
;globalThis.__GAME__ = {
  ...
  CFG, META, UPGRADES, SPIDER_Y, FUSE_COST, keys,
  newRun, startShift, endShift, update, mods, maxStrikes,
  spawnPassenger, buyUpgrade, buyFuse, buyMeta, loadSave, persist,
  nearestFloorIdx, isAligned, doorsOpen, ridersAboard, enterSpider,
};
`;
